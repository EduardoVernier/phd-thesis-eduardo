...
\begin{itemize}
    ...
    \item Patient \textit{c} was diagnosed with chorea and displays high amplitude random non-rhythmic movements. \eduardo{Are we allowed to upload censored videos to a website?}
\end{itemize}
...
All the previous analysis was done atop of a single G-PCA projection, but the other methods implemented into the tool might offer different perspectives into the data which in turn could be useful in other tasks. \cref{fig:diff-projs}
