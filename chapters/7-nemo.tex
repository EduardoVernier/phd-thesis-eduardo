...
However, the joint EMG and acceletrometry data is large (in terms of number of sample points), high-dimensional (has many independent variables), and temporal -- and, as such, it is challenging to analyze and interpret. On the other hand, this is exactly the type of data that our dynamic projection methods presented in the previous chapters were designed for.
...
%
Given the novelty of our approach and the initial positive results obtained, several points can be discussed in order to improve our visual analytics tool to make it more effective for tackling questions related to phenotypic classification and understanding as well as EMG and accelerometer data exploration. Below we discuss several such points and indicate directions for future work and further exploration.
