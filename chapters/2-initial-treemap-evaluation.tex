...
\alex{Please read the above and compare it with your initial text. It's fundamentally the same but devil in the details. Don't do THAT fast: go step by step, relating securely to what was said ALREADY in the thesis! Also don't hardcode cross-refs like "Chapter 3" or whatever. Use labels and ref statements (!) Also, very important, add a footnote to the 1st para in every chapter based on a paper, and in the footnote, say "This chapter is based on the paper [next give ALL the details of the paper, not just the Bibtex ref]"}
