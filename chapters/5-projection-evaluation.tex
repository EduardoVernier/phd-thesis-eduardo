...
\begin{itemize}
  ...
  \item \textbf{fashion:} 100 images from each of the 10 classes (T-shirt/top, trouser, pullover, dress, coat, sandal, shirt, sneaker, bag, ankle boot) of the FashionMNIST\,\citep{Xiao2017} dataset with decreasing amounts of noise over time.
