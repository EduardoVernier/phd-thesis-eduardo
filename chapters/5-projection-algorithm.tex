...
\begin{figure*}[h]
 \centering
 \includegraphics[width=0.7\linewidth]{figures/projection-algorithm/demo-instability-trails-rebuttal-with-color-3.eps}
...
%Comparatively few works use projections to explore temporal (time-dependent) high-dimensional data. Most importantly, few authors explicitly propose techniques and strategies for creating stable projections for temporal\,\cite{Rauber2016,Vernier2020} and for streaming data\,\cite{Neves2020}.
...
%A number of these strategies were proposed by Rauber \emph{et al.} \cite{Rauber2016} using t-SNE as testbed, but were not implemented or quantitatively tested. 
%Later, Vernier \emph{et al.} \cite{Vernier2020} explored the idea further, benchmarking the proposed methods and applying these strategies to other base algorithms. These strategies, according to our taxonomy, are:
...
\end{equation*}
%
%\alex{Wait, below you introduce alpha and beta, but these do NOT appear AT ALL earlier. You cannot introduce them just like that in the formulation of the gradient.}
%
...
%This allows us next to study the spatial quality of projections at different scales\,\cite{Martins2015}. \alex{Wait, this was for the earlier paper. Which $k$ do you use for the \emph{current} paper, since you don't do this multiscale analysis?}
...
\begin{figure*}[htb!]
  \centering
  \includegraphics[width=0.92\linewidth]{figures/projection-algorithm/cifar10grid-with-circles2.pdf}
